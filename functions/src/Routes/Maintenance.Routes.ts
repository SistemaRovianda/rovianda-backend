...
export const maintenanceRoutes:Array<routeInterface>=[
    ...
    {
        url:"/rovianda/maintenance/week/:week",
        method:"get",
        controller:MaintenanceController,
        target:"getMaintenanceByWeek"
    },
    {
        url:"/rovianda/maintenance/stores",
        method:"get",
        controller:MaintenanceController,
        target:"getStores"
    },
    {
        ...
        method:"get",
        controller:MaintenanceController,
        target:"getMaintenanceById"
    },
    {
        url:"/rovianda/maintenance/list/device",
        method:"get",
        controller:MaintenanceController,
        target:"getAllDevicesStore"
    },
    {
        url:"/rovianda/maintenance/store/device",
        method:"post",
        controller:MaintenanceController,
        target:"getStoreMaintenance"
    }
];